...
It is work in progress but introduces many new features as well as MCP to allow you use this app with Claude desktop.
...
| AI | [TanStack AI](https://tanstack.com/ai/latest) + `@tanstack/ai-ollama` |
